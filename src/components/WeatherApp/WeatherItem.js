...
const WeatherItem = (props) => {
    ...
    <li className="day-icon"><img src={'http://openweathermap.org/img/w/' + props.weather[0].icon + '.png'} alt="icon" /></li>
    <li className="day-temp">{Math.floor(props.main.temp - 273, 15) + ' °C'}</li>
        </ul>
    );
};
